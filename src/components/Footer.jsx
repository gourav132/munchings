      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-xl font-medium text-gray-900">Munchings</h3>
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-xl font-medium text-gray-900">Newsletter</h3>
            ...
            <form className="flex space-x-2">
              <input
                ...
                className="flex-1 min-w-0 px-3 py-2 text-sm text-gray-900 placeholder-gray-400 border border-gray-200 rounded-md focus:outline-none focus:border-amber-500"
              />
              <motion.button
        ...
        >
          <p>
            &copy; {new Date().getFullYear()} Munchings. All rights reserved.
          </p>
        </motion.div>
      </div>
    </footer>
