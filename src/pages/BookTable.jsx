        ...
        >
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                Thank you for booking a table with us, {formData.name}. We've sent a confirmation email to {formData.email}.
              </motion.p>
              <motion.div 
              ...
              >
                <h3 className="text-xl font-semibold text-amber-800 mb-4">Reservation Details</h3>
              ...
              >
                If you need to modify or cancel your reservation, please contact us at (555) 123-4567.
              </motion.p>
              <motion.button
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div 
              ...
              transition={{ duration: 0.5 }}
            >
              <h1 className="text-4xl font-bold text-amber-800 mb-4">Reserve Your Table</h1>
              <div className="w-24 h-1 bg-amber-600 mx-auto mb-6"></div>
              <p className="text-lg text-gray-700 max-w-3xl mx-auto">
                Book your dining experience at Savoria. We recommend making reservations at least 2 hours in advance.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <motion.div 
                ...
                transition={{ duration: 0.5, delay: 0.2 }}
              >
                <h2 className="text-2xl font-semibold text-amber-800 mb-6">Reservation Details</h2>
              ...
              >
                <motion.div 
                  ...
                  whileHover={{ y: -5 }}
                >
                  <h2 className="text-2xl font-semibold text-amber-800 mb-6">Reservation Information</h2>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-gray-900">Reservation Hours</h3>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">We hold reservations for 15 minutes past the scheduled time. After that, tables may be given to waiting guests.</p>
                      </div>
                    </motion.div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Please notify us at least 2 hours in advance for cancellations or changes to your reservation.</p>
                      </div>
                    </motion.div>
                  </div>
                </motion.div>
                ...
                <motion.div 
                  ...
                  whileHover={{ y: -5 }}
                >
                  <h2 className="text-2xl font-semibold text-amber-800 mb-6">Need Help?</h2>
                  <p className="text-gray-700 mb-4">
                    For parties larger than 10, special events, or if you need immediate assistance, please contact us directly:
                  </p>
                  <motion.div 
